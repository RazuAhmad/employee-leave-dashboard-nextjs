                    ...
                    <div className="main-dashboard-area pt-9 pr-[121px] pl-[42px]">
                        ...
                        <div className='grid grid-cols-12 gap-x-4 mb-6'>
                            ...
                            <Card>
                                ...
                                <div>
                                    <p> <span>4</span> Taken</p>
                                    <p> <span>2</span> days scheduled</p>
                                </div>
                            </Card>
                        ...
                        <Tabs defaultValue="account" className=" ">
                            <TabsList className='pl-20'>
                                <TabsTrigger className='py-4 px-6 focus:border-b-4  focus:border-blue-600' value="new-leave">New Leave</TabsTrigger>

                                <TabsTrigger value="leave-status" className='px-6 py-4 focus:border-b-4  focus:border-blue-600'>Leave Status</TabsTrigger>

                                <TabsTrigger value="balance" className='px-6 py-4 focus:border-b-4  focus:border-blue-600'>Balance</TabsTrigger>
                            </TabsList>
                                        ...
                                        <div className="grid grid-cols-2 gap-12">
                                            ...
                                            <div>
                                                ...
                                                <div className='flex justify-between mb-[34px]'>
                                                    <label htmlFor="vacation">Leave Type <span className='text-[#FF5449]'>*</span></label>
                                                    <select name="" id="vacation" className='px-4 w-[296px] h-14 rounded-sm  border-[0.5px] border-[#919094]'>
                                                        <option value="vacation">Vacation</option>
                                                    </select>
                                                </div>
                                                <div className='flex justify-between mb-[34px]'>
                                                    <label htmlFor="vacation">From Date <span className='text-[#FF5449]'>*</span></label>
                                                    <div>
                                                        <input type="date" name="" id="" className='px-4 w-[296px] h-14 rounded-sm border-[0.5px] border-[#919094] mb-2' />
                                                        <br />
                                                        <div className="flex gap-4 items-center">
                                                            <input type="checkbox" name="oneDayOnly" id="oneDayOnly" value="oneDayOnly" />
                                                ...
                                                <div className='flex justify-between mb-[34px]'>
                                                    <label htmlFor="vacation">To Date <span className='text-[#FF5449]'>*</span></label>
                                                    <input type="date" name="" id="" className='px-4 w-[296px] h-14 rounded-sm border-[0.5px] border-[#919094]' />
                                                </div>
                                                <div className='flex justify-between mb-[34px]'>
                                                    <label htmlFor="vacation">Leave Type <span className='text-[#FF5449]'>*</span></label>
                                                    <select name="" id="vacation" className='px-4 w-[296px] h-14 rounded-sm border-[0.5px] border-[#919094]'>
                            ...
                            <TabsContent value="leave-status">
                                <div className='pl-20 pr-[163px] pt-6 bg-[#F2F0F4]'>
                                    ...
                                    <p> <span className='text-red-400'>Leave status</span>
                            ...
                            <TabsContent value="balance">
                                <div className='pl-20 pr-[163px] pt-6 bg-[#F2F0F4]'>
                                    ...
                                    <p> <span className='text-red-400'>Balance</span>
                                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo, quam.
                                    </p>
